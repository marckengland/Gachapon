 ...
 */
public class logicEasy extends javax.swing.JFrame {
    ...
    public void initData(){
        // Question
        quiz[0][0] = "<html><p align=\"center\">If a giraffe has two eyes, a monkey has two eyes, and an elephant has two eyes, how many eyes do we have?</p></html>"; 
        
        // Choices
        quiz[0][1] = "A. 3";
        quiz[0][2] = "B. 4"; // Correct Answer
        quiz[0][3] = "C. 1";
        quiz[0][4] = "D. 2";
        quiz[0][5] = "2"; // Index of the Correct Answer
        
        // Question
        quiz[1][0] = "<html><p align=\"center\">What is black when you buy it, red when you use it, and gray when you throw it away?</p></html>"; 
        
        // Choices
        quiz[1][1] = "A. Shoe";
        quiz[1][2] = "B.Charcoal"; // Correct Answer
        quiz[1][3] = "C. Belt";
        quiz[1][4] = "D. All of the above";
        quiz[1][5] = "2"; // Index of the Correct Answer
        
        
        // Question
        quiz[2][0] = "<html><p align=\"center\">They come out at night without being called and are lost in the day without being stolen. What are they?</p></html>"; 
        
        // Choices
        quiz[2][1] = "A. Light";
        quiz[2][2] = "B. Bats";
        quiz[2][3] = "C. Stars"; // Correct Answer
        quiz[2][4] = "D. Flights";
        quiz[2][5] = "3"; // Index of the Correct Answer
        
        
        // Question
        quiz[3][0] = "<html><p align=\"center\">QPO, NML, KJI, ___, EDC</p></html>"; 
        ...
        // Question
        quiz[4][0] = "<html><p align=\"center\">What has teeth but cannot bite?</p></html>"; 
        ...
        // Question
        quiz[5][0] = "<html><p align=\"center\">Poor people have it. Rich people need it.If you eat it you die.</p></html>"; 
        
        // Choices
        quiz[5][1] = "A. Money";
        quiz[5][2] = "B. Brain";
        quiz[5][3] = "C. Luxury Items";
        quiz[5][4] = "D. Nothing";
        quiz[5][5] = "4"; // Index of the Correct Answer
        
        
        // Question
        quiz[6][0] = "<html><p align=\"center\">What has a spine but no bones?</p></html>"; 
        
        // Choices
        quiz[6][1] = "A. Mirror";
        quiz[6][2] = "B. Book";
        quiz[6][3] = "C. Table";
        quiz[6][4] = "D. None of the above";
        quiz[6][5] = "2"; // Index of the Correct Answer
        
        
        // Question
        quiz[7][0] = "<html><p align=\"center\">FAG, GAF, HAI, IAH, ___</p></html>"; 
        ...
        // Question
        quiz[8][0] = "<html><p align=\"center\">ELFA, GLHA, ILJA, ____, MLNA</p></html>"; 
        ...
        // Question
        quiz[9][0] = "<html><p align=\"center\">Samantha is your father’s mother’s grandson’s daughter. Therefore, Samantha is your?</p></html>"; 
        
        // Choices
        quiz[9][1] = "A. Niece";
        quiz[9][2] = "B. Sister";
        quiz[9][3] = "C. Aunt";
        quiz[9][4] = "D. Step Sister";
